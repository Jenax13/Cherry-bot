...
global.reloadHandler = function () {
  ...
  conn.bye = '┏━━━━━━━━━━━━\n┃──〘 *ADIOS* 〙───\n┃━━━━━━━━━━━━\n┃ *_☠ Se fue @user_* \n┃ *🌸La cereza escapó del multiverso🌸* \n┃ *No pregunten🍒💀**\n┗━━━━━━━━━━'
  conn.spromote = '@user Ahora es un admin de cereza supremo🍒!'
  conn.sdemote = '@user Cerezas retiradas 🍒❌ privilegios de admin revocados!'
...
_quickTest()
  ...
  .catch(console.error)  if (pluginFilter(filename)) {
    let dir = path.join(pluginFolder, filename)
    if (dir in require.cache) {
      delete require.cache[dir]
      if (fs.existsSync(dir)) conn.logger.info(`re - require plugin '${filename}'`)
